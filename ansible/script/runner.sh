...
services:
  frontend:
    image: 426857564226.dkr.ecr.us-east-1.amazonaws.com/testujwal001:frontend-706794d-20240608071007
    ports:
      - 8080:80
    depends_on:
      - backend
  backend:
    image: 426857564226.dkr.ecr.us-east-1.amazonaws.com/testujwal001:backend-706794d-20240608071007
    ports:
      - 8081:80
    depends_on:
      - mysql-test
